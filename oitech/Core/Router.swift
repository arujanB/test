...
public final class Router {
    ...
    @discardableResult
    public func popToViewController<T>(type: T.Type, animated: Bool = true, completion: @escaping () -> Void = {}) -> T? {
        guard let viewController = navigationController.viewControllers.first(where: { $0 is T }) else { return nil }
